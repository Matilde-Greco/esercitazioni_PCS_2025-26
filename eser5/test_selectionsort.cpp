...
int main() {
    ...
    cout<<"il selectionsort ha fatto il suo lavoro sui numeri\n";
    ...
    if (!is_sorted(stringa)){
            cerr<<"il selectionsort non ha fatto il suo lavoro sulle stringhe \n";
            return EXIT_FAILURE;
        }
    cout<<"il selectionsort ha fatto il suo lavoro sulle stringhe\n";
