...
int main(){
    ...
    cout<<"il bubblesort ha fatto il suo lavoro sui numeri\n";

    vector<string> stringa={"ciao", "mamma", "papa", "nonna", "nonno", "cugina", "zio", "parente", "nicole", "conni"};
    bubble_sort(stringa);

    if (!is_sorted(stringa)){
            cerr<<"il bubblesort non ha fatto il suo lavoro sulle stringhe \n";
            return EXIT_FAILURE;
        }
    cout<<"il bubblesort ha fatto il suo lavoro sulle stringhe\n";
