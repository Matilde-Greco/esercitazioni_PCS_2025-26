...
int main() {
    ...
    for (int i=0; i<100;i++){
        ...
        if (!is_sorted(casuali.begin(),casuali.end())){
            cerr<<"il mergesort non ha fatto il suo lavoro sui numeri \n";
            return EXIT_FAILURE;
        }
    }
    cout<<"il mergesort ha fatto il suo lavoro sui numeri\n";
    ...
    if (!is_sorted(stringa)){
            cerr<<"il mergesort non ha fatto il suo lavoro sulle stringhe \n";
            return EXIT_FAILURE;
        }
    cout<<"il mergesort ha fatto il suo lavoro sulle stringhe\n";
